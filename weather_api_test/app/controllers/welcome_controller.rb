class WelcomeController < ApplicationController
  def test
    response = HTTParty.get("http://api.wunderground.com/api/#{ENV['weather_underground_api_key']}/geolookup/conditions/q/AZ/Phoenix.json")
  ...
  results = HTTParty.get("http://api.wunderground.com/api/#{Figaro.env.weather_underground_api_key}/geolookup/conditions/q/#{params[:state]}/#{params[:city]}.json")
